...
void buildScene(void)
{
 ...
 p.px=1.17;			// Set a light source at the origin, pointing in direction
 p.py=-1.17;			// (1.0, -.8)  (remember that Y increases downward!)
 d.px=1.0;			// This ray should hit both spheres, so you can test your
 d.py=-1.0;			// intersection code. The closest sphere is reflecting, so
