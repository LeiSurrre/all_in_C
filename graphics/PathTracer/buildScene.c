void buildScene(void)
{
 ...
 // Two spheres scene
 // o=newSphere(0.0,0.2,0.8,.99,.99,.99,.01,1.54);		// Refract
...
*/
 ...
 o=newSphere(1.0,0.0,0.0,.99,.99,.99,.01,1.54);   // body
 Scale(o,4.75,1.75,1.75);
 Translate(o,0,-2.0,4.5);
 invert(&o->T[0][0],&o->Tinv[0][0]);
 loadTexture(o,"./textures/texture3.ppm",1,&texture_list);
 insertObject(o,&object_list);

 o=newCyl(1.0,0.0,0.0,.99,.99,.99,.01,1.54);   // neck
 Scale(o,0.5,0.5,2.0);
 RotateX(o,-PI/2);
 RotateZ(o,PI/9);
 Translate(o,-3.5,1.0,4.25);
 invert(&o->T[0][0],&o->Tinv[0][0]);
 loadTexture(o,"./textures/texture3.ppm",1,&texture_list);
 insertObject(o,&object_list);

 o=newSphere(1.0,0.0,0.0,.99,.99,.99,.01,1.54);   // head
 Scale(o,2.25,1.0,1.0);
 Translate(o,-3.0,5.0,4.0);
 RotateZ(o,PI/6);
 invert(&o->T[0][0],&o->Tinv[0][0]);
 loadTexture(o,"./textures/texture3.ppm",1,&texture_list);
 insertObject(o,&object_list);

 o=newSphere(1.0,0.0,0.0,.99,.99,.99,.01,1.54);   // ear
 Scale(o,1.25,0.3,0.3);
 RotateZ(o,PI/2);
 Translate(o,-3.5,5.0,4.25);
 invert(&o->T[0][0],&o->Tinv[0][0]);
 loadTexture(o,"./textures/texture3.ppm",1,&texture_list);
 insertObject(o,&object_list);
 ...
 Scale(o,1.25,0.3,0.3);
 RotateZ(o,PI/2);
 Translate(o,-3.5,5.0,3.75);
 invert(&o->T[0][0],&o->Tinv[0][0]);
 loadTexture(o,"./textures/texture3.ppm",1,&texture_list);
 insertObject(o,&object_list);

 o=newCyl(1.0,0.0,0.0,.99,.99,.99,.01,1.54);   // leg
 Scale(o,0.5,0.5,4.0);
 RotateX(o,-PI/2);
 RotateZ(o,-PI/10);
 Translate(o,-3.0,-5.0,3.75);
 invert(&o->T[0][0],&o->Tinv[0][0]);
 loadTexture(o,"./textures/texture3.ppm",1,&texture_list);
 insertObject(o,&object_list);
 ...
 o=newSphere(1.0,0.0,0.0,.99,.99,.99,.01,1.54);   // tail
 Scale(o,3.25,0.7,0.7);
 RotateZ(o,PI/6);
 Translate(o,5.0,-2.75,4.25);
 RotateZ(o,PI/6);
 invert(&o->T[0][0],&o->Tinv[0][0]);
 loadTexture(o,"./textures/texture4.ppm",1,&texture_list);
 insertObject(o,&object_list);
